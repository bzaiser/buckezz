...
urlpatterns = [
    ...
    path('list/<uuid:pk>/pdf/', pdf_views.DownloadLandingPageView.as_view(), name='export_pdf'),
    path('list/<uuid:pk>/pdf/raw/', pdf_views.ExportListPDFView.as_view(), name='export_pdf_raw'),
